...
document.getElementById("button").onclick = function(){
  ...
  wegle = (wynikB) * 0.55 / 4;
   document.getElementById("wynik").textContent =   Math.round(wynikB) + " kcal dziennie";
   document.getElementById("1").textContent = Math.round(tluszcz)  + "g tłuszczu";
   document.getElementById("2").textContent = Math.round(bialko)  + "g białka";
   document.getElementById("3").textContent = Math.round(wegle)  + "g węglowodanów";
}
